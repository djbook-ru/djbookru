...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('adzone_adimpression', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('impression_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.create_table('adzone_adclick', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('click_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('source_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True)),
            ('ad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adzone.AdBase'])),
        ))
    ...
    models = {
        ...
        'adzone.adclick': {
            ...
            'click_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'adzone.adimpression': {
            ...
            'ad': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adzone.AdBase']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'impression_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'source_ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
        'adzone.advertiser': {
