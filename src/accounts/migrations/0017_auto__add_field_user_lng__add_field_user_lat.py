...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.lng'
        db.add_column('accounts_user', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.lat'
        db.add_column('accounts_user', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.lng'
        db.delete_column('accounts_user', 'lng')

        # Deleting field 'User.lat'
        db.delete_column('accounts_user', 'lat')
