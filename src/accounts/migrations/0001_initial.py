...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_user', (
            ...
            ('last_session_activity', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('posts_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('last_posttime', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True)),
        ))
