...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userachievement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
            ('achievement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Achievement'])),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('accounts', ['UserAchievement'])

        # Adding unique constraint on 'UserAchievement', fields ['user', 'achievement']
        db.create_unique('accounts_userachievement', ['user_id', 'achievement_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserAchievement', fields ['user', 'achievement']
        db.delete_unique('accounts_userachievement', ['user_id', 'achievement_id'])

        # Deleting model 'UserAchievement'
        db.delete_table('accounts_userachievement')
