...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.last_comments_read'
        db.add_column('accounts_user', 'last_comments_read', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'User.last_doc_comments_read'
        db.add_column('accounts_user', 'last_doc_comments_read', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.last_comments_read'
        db.delete_column('accounts_user', 'last_comments_read')

        # Deleting field 'User.last_doc_comments_read'
        db.delete_column('accounts_user', 'last_doc_comments_read')
