...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_user', 'country',
                      self.gf('src.accounts.countries.CountryField')(max_length=2, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'User.country'
        db.delete_column('accounts_user', 'country')
