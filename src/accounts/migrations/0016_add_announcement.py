...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        obj = orm.Announcement()
        obj.title = u'Документация Django на русском'
        obj.link = u'http://127.0.0.1:8000/static/html/index.html'
        obj.content = u'Документация на русском языке для Django стала реальностью. Благодаря новым возможностям движка Sphinx мы можем оперативно дополнять перевод, по мере обновления оригинальной документации.'
        obj.save()
