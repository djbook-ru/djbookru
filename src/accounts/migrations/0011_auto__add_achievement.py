...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_achievement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('active_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('inactive_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('accounts', ['Achievement'])


    def backwards(self, orm):
        
        # Deleting model 'Achievement'
        db.delete_table('accounts_achievement')
