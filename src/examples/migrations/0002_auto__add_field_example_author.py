...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Example.author'
        db.add_column('examples_example', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Example.author'
        db.delete_column('examples_example', 'author_id')
    ...
    models = {
        'accounts.user': {
            ...
            'last_posttime': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_session_activity': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
