...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('doc_comments_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='doc_comments', to=orm['accounts.User'])),
            ('page', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('xpath', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('doc_comments', ['Comment'])


    def backwards(self, orm):
        
        # Deleting model 'Comment'
        db.delete_table('doc_comments_comment')
