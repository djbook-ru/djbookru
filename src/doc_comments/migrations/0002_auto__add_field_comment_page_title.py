...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.page_title'
        db.add_column('doc_comments_comment', 'page_title', self.gf('django.db.models.fields.CharField')(default='Title', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.page_title'
        db.delete_column('doc_comments_comment', 'page_title')
