...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Visit'
        db.create_table('forum_visit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='forum_visits', to=orm['accounts.User'])),
        ...
        db.send_create_signal('forum', ['Visit'])

        # Adding unique constraint on 'Visit', fields ['user', 'topic']
        db.create_unique('forum_visit', ['user_id', 'topic_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Visit', fields ['user', 'topic']
        db.delete_unique('forum_visit', ['user_id', 'topic_id'])

        # Deleting model 'Visit'
        db.delete_table('forum_visit')
