...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('forum_post', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field votes on 'Post'
        m2m_table_name = db.shorten_name('forum_post_votes')
        ...
        # Adding field 'Topic.rating'
        db.add_column('forum_topic', 'rating',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field votes on 'Topic'
        m2m_table_name = db.shorten_name('forum_topic_votes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_column('forum_post', 'rating')

        # Removing M2M table for field votes on 'Post'
        db.delete_table(db.shorten_name('forum_post_votes'))

        # Deleting field 'Topic.rating'
        db.delete_column('forum_topic', 'rating')

        # Removing M2M table for field votes on 'Topic'
        db.delete_table(db.shorten_name('forum_topic_votes'))
