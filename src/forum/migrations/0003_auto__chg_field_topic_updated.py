...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.updated'
        db.alter_column('forum_topic', 'updated', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Topic.updated'
        db.alter_column('forum_topic', 'updated', self.gf('django.db.models.fields.DateTimeField')(null=True))
