...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field rated_by on 'Snipet'
        m2m_table_name = db.shorten_name('code_review_snipet_rated_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('snipet', models.ForeignKey(orm['code_review.snipet'], null=False)),
            ('user', models.ForeignKey(orm['accounts.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['snipet_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field rated_by on 'Snipet'
        db.delete_table(db.shorten_name('code_review_snipet_rated_by'))
    ...
    models = {
        ...
        'code_review.snipet': {
            ...
            'rated_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'rated_snippets'", 'symmetrical': 'False', 'to': "orm['accounts.User']"}),
