...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sentry_message', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GroupedMessage.first_seen'
        db.alter_column('sentry_groupedmessage', 'first_seen', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GroupedMessage.last_seen'
        db.alter_column('sentry_groupedmessage', 'last_seen', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Changing field 'Message.datetime'
        db.alter_column('sentry_message', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'GroupedMessage.first_seen'
        db.alter_column('sentry_groupedmessage', 'first_seen', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'GroupedMessage.last_seen'
        db.alter_column('sentry_groupedmessage', 'last_seen', self.gf('django.db.models.fields.DateTimeField')())
